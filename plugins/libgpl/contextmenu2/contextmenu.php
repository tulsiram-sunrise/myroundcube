 ...
 */
class contextmenu_core extends rcube_plugin
{
	...
	function init()
	{
		...
		if ($rcmail->output->type == 'html') {
			...
			$rcmail->output->add_header(html::tag('script', array('type' => 'text/javascript', 'src' => 'plugins/libgpl/contextmenu2/contextmenu.js')));
