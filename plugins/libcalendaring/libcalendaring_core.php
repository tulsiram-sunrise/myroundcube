...
class libcalendaring_core extends rcube_plugin
{
    public $rc;
    public $timezone;
    public $gmt_offset;
...
//        $action = rcube_utils::get_input_value('action', rcube_utils::INPUT_GPC);
    ...
    public function recurrence_warning($attrib = array())
    {
        ...
        $form = html::label(null, $radio->show('', array('value' => 'current')) . $this->gettext('currentobject')) . ' ' .
            html::label(null, $radio->show('', array('value' => 'future')) . $this->gettext('futureobjects')) . ' ' .
            html::label(null, $radio->show('all', array('value' => 'all')) . $this->gettext('allobjects')) . ' ' .
            html::label(null, $radio->show('', array('value' => 'new')) . $this->gettext('saveasnew'));
