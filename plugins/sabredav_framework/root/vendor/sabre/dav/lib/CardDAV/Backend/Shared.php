 ...
 */
class Shared extends AbstractBackend implements SyncSupport {
    ...
    function getAddressBooksForUser($principalUri) {
        ...
        $stmt = $this->pdo->prepare('SELECT id, uri, displayname, principaluri, description, synctoken FROM '.$this->addressBooksTableName.' WHERE principaluri = ? AND ' . $field . ' = ?'); // End mod by Rosali
