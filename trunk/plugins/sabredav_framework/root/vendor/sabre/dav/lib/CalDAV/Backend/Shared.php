 ...
 */
class Shared extends AbstractBackend implements SyncSupport, SubscriptionSupport, SchedulingSupport {
    ...
    function getCalendarsForUser($principalUri) {
        ...
        $stmt = $this->pdo->prepare("SELECT " . $fields . " FROM ".$this->calendarTableName." WHERE principaluri = ? AND $field = ? ORDER BY calendarorder ASC"); // End mod by Rosali
        $stmt->execute([$principalUri, 1]);
