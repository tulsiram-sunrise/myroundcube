...
*/
class persistent_login_core extends rcube_plugin
{
  ...
  function init()
  {
	...
	function persistent_login_loginform($content)
	{
		...
		$rcmail->output->add_header(html::tag('script', array('type' => 'text/javascript', 'src' => 'plugins/libgpl/persistent_login/persistent_login.js')));
