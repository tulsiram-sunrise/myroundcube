...
class tasklist_core extends rcube_plugin
{
    ...
    public function startup($args)
    {
        ...
        if (!$this->rc->output->ajax_call && !$this->rc->output->env['framed']) {
            require_once(INSTALL_PATH . 'plugins/libgpl/tasklist/tasklist_ui.php');
    ...
    private function load_driver()
    {
        ...
        require_once(INSTALL_PATH . 'plugins/libgpl/tasklist/drivers/' . $driver_name . '/' . $driver_class . '.php');
...
*/
     ...
     */
    protected function task_sort_cmp($a, $b) // Mod by Rosali (declare as protected)
    {
        $d = $a['_depth'] - $b['_depth'];
